...
def create_dataset_from_pairs(pairs, labels, batch_size=16):
    def data_generator():
...
# Create datasets
train_dataset = create_dataset_from_pairs(train_pairs, train_labels, batch_size=16)
val_dataset = create_dataset_from_pairs(val_pairs, val_labels, batch_size=16)
